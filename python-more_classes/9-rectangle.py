...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Function that returns the biggest rectangle by area"""
        msg_err_ins1 = "rect_1 must be an instance of Rectangle"
        msg_err_ins2 = "rect_2 must be an instance of Rectangle"
