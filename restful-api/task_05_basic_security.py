#!/usr/bin/python3
"""Flask API with Basic Auth, JWT Authentication, and Role-Based Access Control."""
...
app = Flask(__name__)
app.config["JWT_SECRET_KEY"] = "super-secret-key-that-is-long-enough-for-hmac"
...
def handle_needs_fresh_token_error(jwt_header, jwt_payload):
    """Handle request that needs a fresh token."""
